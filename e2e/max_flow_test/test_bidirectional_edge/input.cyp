...
MERGE (a:Node {id: 4}) MERGE (b:Node {id: 3}) CREATE (a)-[:RELATION {weight: 1}]->(b);
MERGE (a:Node {id: 3}) MERGE (b:Node {id: 5}) CREATE (a)-[:RELATION {weight: 14}]->(b);
MERGE (a:Node {id: 4}) MERGE (b:Node {id: 5}) CREATE (a)-[:RELATION {weight: 8}]->(b);
queries:
    ...
    - |-
        CREATE (a:Node {id: 15});
        MERGE (a:Node {id: 15}) MERGE (b:Node {id: 8}) CREATE (a)-[:RELATION]->(b);
        MERGE (a:Node {id: 8}) MERGE (b:Node {id: 15}) CREATE (a)-[:RELATION]->(b);
        MERGE (a:Node {id: 15}) MERGE (b:Node {id: 10}) CREATE (a)-[:RELATION]->(b);
        MERGE (a:Node {id: 10}) MERGE (b:Node {id: 15}) CREATE (a)-[:RELATION]->(b);
        MERGE (a:Node {id: 15}) MERGE (b:Node {id: 14}) CREATE (a)-[:RELATION]->(b);
        ...
        MATCH (a:Node {id: 5})-[r:RELATION]->(b:Node {id: 4}) DELETE r;
        MATCH (a:Node {id: 4})-[r:RELATION]->(b:Node {id: 5}) DELETE r;
        MATCH (a:Node {id: 5})-[r:RELATION]->(b:Node {id: 7}) DELETE r;
        MATCH (a:Node {id: 7})-[r:RELATION]->(b:Node {id: 5}) DELETE r;
        MATCH (a:Node {id: 5})-[r:RELATION]->(b:Node {id: 8}) DELETE r;
        MATCH (a:Node {id: 8})-[r:RELATION]->(b:Node {id: 5}) DELETE r;

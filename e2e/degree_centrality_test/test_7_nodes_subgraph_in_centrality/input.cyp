...
MERGE (a:Node {id: 3}) MERGE (b:Node {id: 6}) CREATE (a)-[:RELATION]->(b);
...
MERGE (a:Node {id: 5}) MERGE (b:Node {id: 1}) CREATE (a)-[:RELATION]->(b);
MERGE (a:Node {id: 5}) MERGE (b:Node {id: 4}) CREATE (a)-[:RELATION]->(b);
MERGE (a:Node {id: 6}) MERGE (b:Node {id: 0}) CREATE (a)-[:RELATION]->(b);
MERGE (a:Node {id: 0}) MERGE (b:Node {id: 5}) CREATE (a)-[:RELATION_NEW]->(b);
MERGE (a:Node {id: 1}) MERGE (b:Node {id: 2}) CREATE (a)-[:RELATION_NEW]->(b);
MERGE (a:Node {id: 7}) MERGE (b:Node {id: 1}) CREATE (a)-[:RELATION_NEW]->(b);
MERGE (a:Node {id: 7}) MERGE (b:Node {id: 4}) CREATE (a)-[:RELATION_NEW]->(b);
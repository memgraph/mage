setup: |-
    CALL link_prediction.set_model_parameters({add_self_loops: True, device_type: "cuda", split_ratio: 1.0, hidden_features_size: [3, 2], target_relation: "SUBSCRIBES_TO", add_reverse_edges: False}) YIELD *;

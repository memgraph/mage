...
This is fairly simple installation setup to follow:

```
# 1. [IF NEEDED] Install the newer version of CMake since it is requirement for cuGraph CMakeLists.txt
...
# 2. [IF NEEDED] Install CUDA on your device
...
# 2. To use CUDA and NVIDIA cuGraph code, compile with the different flags

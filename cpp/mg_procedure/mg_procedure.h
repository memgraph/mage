...
enum MGP_NODISCARD mgp_error_code {
...
enum mgp_error_code mgp_alloc(struct mgp_memory *memory, size_t size_in_bytes, void **result);
...
/// The returned pointer must be freed with mgp_free.
/// NULL is returned if unable to serve the requested allocation.
enum mgp_error_code mgp_aligned_alloc(struct mgp_memory *memory, size_t size_in_bytes, size_t alignment, void **result);
...
/// NULL is returned if unable to serve the requested allocation.
enum mgp_error_code mgp_global_alloc(size_t size_in_bytes, void **result);
...
/// The returned pointer must be freed with mgp_global_free.
/// NULL is returned if unable to serve the requested allocation.
enum mgp_error_code mgp_global_aligned_alloc(size_t size_in_bytes, size_t alignment, void **result);
...
enum mgp_error_code mgp_value_make_null(struct mgp_memory *memory, struct mgp_value **result);

/// Construct a boolean value.
/// Non-zero values represent `true`, while zero represents `false`.
/// You need to free the instance through mgp_value_destroy.
/// NULL is returned if unable to allocate a mgp_value.
enum mgp_error_code mgp_value_make_bool(int val, struct mgp_memory *memory, struct mgp_value **result);

/// Construct an integer value.
/// You need to free the instance through mgp_value_destroy.
/// NULL is returned if unable to allocate a mgp_value.
enum mgp_error_code mgp_value_make_int(int64_t val, struct mgp_memory *memory, struct mgp_value **result);

/// Construct a double floating point value.
/// You need to free the instance through mgp_value_destroy.
/// NULL is returned if unable to allocate a mgp_value.
enum mgp_error_code mgp_value_make_double(double val, struct mgp_memory *memory, struct mgp_value **result);

/// Construct a character string value from a NULL terminated string.
/// You need to free the instance through mgp_value_destroy.
/// NULL is returned if unable to allocate a mgp_value.
enum mgp_error_code mgp_value_make_string(const char *val, struct mgp_memory *memory, struct mgp_value **result);
...
/// NULL is returned if unable to allocate a mgp_value.
enum mgp_error_code mgp_value_make_list(struct mgp_list *val, struct mgp_value **result);
...
/// NULL is returned if unable to allocate a mgp_value.
enum mgp_error_code mgp_value_make_map(struct mgp_map *val, struct mgp_value **result);
...
/// NULL is returned if unable to allocate a mgp_value.
enum mgp_error_code mgp_value_make_vertex(struct mgp_vertex *val, struct mgp_value **result);
...
/// NULL is returned if unable to allocate a mgp_value.
enum mgp_error_code mgp_value_make_edge(struct mgp_edge *val, struct mgp_value **result);
...
/// NULL is returned if unable to allocate a mgp_value.
enum mgp_error_code mgp_value_make_path(struct mgp_path *val, struct mgp_value **result);

/// Return the type of the value contained in mgp_value.
enum mgp_error_code mgp_value_get_type(const struct mgp_value *val, enum mgp_value_type *result);

/// Return non-zero if the given mgp_value represents `null`.
enum mgp_error_code mgp_value_is_null(const struct mgp_value *val, int *result);

/// Return non-zero if the given mgp_value stores a boolean.
enum mgp_error_code mgp_value_is_bool(const struct mgp_value *val, int *result);

/// Return non-zero if the given mgp_value stores an integer.
enum mgp_error_code mgp_value_is_int(const struct mgp_value *val, int *result);

/// Return non-zero if the given mgp_value stores a double floating-point.
enum mgp_error_code mgp_value_is_double(const struct mgp_value *val, int *result);

/// Return non-zero if the given mgp_value stores a character string.
enum mgp_error_code mgp_value_is_string(const struct mgp_value *val, int *result);

/// Return non-zero if the given mgp_value stores a list of values.
enum mgp_error_code mgp_value_is_list(const struct mgp_value *val, int *result);

/// Return non-zero if the given mgp_value stores a map of values.
enum mgp_error_code mgp_value_is_map(const struct mgp_value *val, int *result);

/// Return non-zero if the given mgp_value stores a vertex.
enum mgp_error_code mgp_value_is_vertex(const struct mgp_value *val, int *result);

/// Return non-zero if the given mgp_value stores an edge.
enum mgp_error_code mgp_value_is_edge(const struct mgp_value *val, int *result);

/// Return non-zero if the given mgp_value stores a path.
enum mgp_error_code mgp_value_is_path(const struct mgp_value *val, int *result);

/// Return the contained boolean value.
/// Non-zero values represent `true`, while zero represents `false`.
/// The result is undefined if mgp_value does not contain the expected type.
enum mgp_error_code mgp_value_get_bool(const struct mgp_value *val, int *result);

/// Return the contained integer.
/// The result is undefined if mgp_value does not contain the expected type.
enum mgp_error_code mgp_value_get_int(const struct mgp_value *val, int64_t *result);

/// Return the contained double floating-point.
/// The result is undefined if mgp_value does not contain the expected type.
enum mgp_error_code mgp_value_get_double(const struct mgp_value *val, double *result);

/// Return the contained character string.
/// The result is undefined if mgp_value does not contain the expected type.
enum mgp_error_code mgp_value_get_string(const struct mgp_value *val, const char **result);

/// Return the contained list of values.
/// The result is undefined if mgp_value does not contain the expected type.
enum mgp_error_code mgp_value_get_list(const struct mgp_value *val, struct mgp_list **result);

/// Return the contained map of values.
/// The result is undefined if mgp_value does not contain the expected type.
enum mgp_error_code mgp_value_get_map(const struct mgp_value *val, struct mgp_map **result);

/// Return the contained vertex.
/// The result is undefined if mgp_value does not contain the expected type.
enum mgp_error_code mgp_value_get_vertex(const struct mgp_value *val, struct mgp_vertex **result);

/// Return the contained edge.
/// The result is undefined if mgp_value does not contain the expected type.
enum mgp_error_code mgp_value_get_edge(const struct mgp_value *val, struct mgp_edge **result);

/// Return the contained path.
/// The result is undefined if mgp_value does not contain the expected type.
enum mgp_error_code mgp_value_get_path(const struct mgp_value *val, struct mgp_path **result);
...
enum mgp_error_code mgp_list_make_empty(size_t capacity, struct mgp_memory *memory, struct mgp_list **result);
...
enum mgp_error_code mgp_list_append(struct mgp_list *list, const struct mgp_value *val);
...
enum mgp_error_code mgp_list_append_extend(struct mgp_list *list, const struct mgp_value *val);

/// Return the number of elements stored in mgp_list.
enum mgp_error_code mgp_list_size(const struct mgp_list *list, size_t *result);

/// Return the total number of elements for which there's already allocated
/// memory in mgp_list.
enum mgp_error_code mgp_list_capacity(const struct mgp_list *list, size_t *result);

/// Return the element in mgp_list at given position.
/// NULL is returned if the index is not within mgp_list_size.
enum mgp_error_code mgp_list_at(struct mgp_list *list, size_t index, struct mgp_value **result);
...
enum mgp_error_code mgp_map_make_empty(struct mgp_memory *memory, struct mgp_map **result);
...
enum mgp_error_code mgp_map_insert(struct mgp_map *map, const char *key, const struct mgp_value *value);

/// Return the number of items stored in mgp_map.
enum mgp_error_code mgp_map_size(const struct mgp_map *map, size_t *result);

/// Return the mapped mgp_value to the given character string.
/// NULL is returned if no mapping exists.
enum mgp_error_code mgp_map_at(struct mgp_map *map, const char *key, struct mgp_value **result);

/// An item in the mgp_map.
struct mgp_map_item;

/// Get the key of the mapped item.
enum mgp_error_code mgp_map_item_key(const struct mgp_map_item *item, const char **result);

/// Get the value of the mapped item.
enum mgp_error_code mgp_map_item_value(struct mgp_map_item *item, struct mgp_value **result);
...
enum mgp_error_code mgp_map_iter_items(const struct mgp_map *map, struct mgp_memory *memory,
...
enum mgp_error_code mgp_map_items_iterator_get(const struct mgp_map_items_iterator *it, struct mgp_map_item **result);
...
/// NULL is returned if the end of the iteration has been reached.
enum mgp_error_code mgp_map_items_iterator_next(struct mgp_map_items_iterator *it, struct mgp_map_item **result);
...
enum mgp_error_code mgp_path_make_with_start(const struct mgp_vertex *vertex, struct mgp_memory *memory,
...
enum mgp_error_code mgp_path_copy(const struct mgp_path *path, struct mgp_memory *memory, struct mgp_path **result);
...
/// for path extension.
enum mgp_error_code mgp_path_expand(struct mgp_path *path, struct mgp_edge *edge);

/// Return the number of edges in a mgp_path.
enum mgp_error_code mgp_path_size(const struct mgp_path *path, size_t *result);
...
enum mgp_error_code mgp_path_vertex_at(struct mgp_path *path, size_t index, struct mgp_vertex **result);

/// Return the edge from a path at given index.
/// The valid index range is [0, mgp_path_size - 1].
/// NULL is returned if index is out of range.
enum mgp_error_code mgp_path_edge_at(struct mgp_path *path, size_t index, struct mgp_edge **result);

/// Return non-zero if given paths are equal, otherwise 0.
enum mgp_error_code mgp_path_equal(struct mgp_path *p1, struct mgp_path *p2, int *result);
...
enum mgp_error_code mgp_result_set_error_msg(struct mgp_result *res, const char *error_msg);
...
enum mgp_error_code mgp_result_new_record(struct mgp_result *res, struct mgp_result_record **result);
...
enum mgp_error_code mgp_result_record_insert(struct mgp_result_record *record, const char *field_name,
...
/// NULL is returned if the end of the iteration has been reached.
enum mgp_error_code mgp_properties_iterator_get(struct mgp_properties_iterator *it, struct mgp_property **result);
...
/// NULL is returned if the end of the iteration has been reached.
enum mgp_error_code mgp_properties_iterator_next(struct mgp_properties_iterator *it, struct mgp_property **result);
...
enum mgp_error_code mgp_vertex_get_id(const struct mgp_vertex *v, struct mgp_vertex_id *result);

/// Copy a mgp_vertex.
/// Returned pointer must be freed with mgp_vertex_destroy.
/// NULL is returned if unable to allocate a mgp_vertex.
enum mgp_error_code mgp_vertex_copy(const struct mgp_vertex *v, struct mgp_memory *memory, struct mgp_vertex **result);
...
enum mgp_error_code mgp_vertex_equal(const struct mgp_vertex *v1, const struct mgp_vertex *v2, int *result);

/// Return the number of labels a given vertex has.
enum mgp_error_code mgp_vertex_labels_count(const struct mgp_vertex *v, size_t *result);

/// Return mgp_label in mgp_vertex at given index.
/// If the index is out of bounds, mgp_label.name is set to NULL.
enum mgp_error_code mgp_vertex_label_at(const struct mgp_vertex *v, size_t index, struct mgp_label *result);

/// Return non-zero if the given vertex has the given label.
enum mgp_error_code mgp_vertex_has_label(const struct mgp_vertex *v, struct mgp_label label, int *result);

/// Return non-zero if the given vertex has a label with given name.
enum mgp_error_code mgp_vertex_has_label_named(const struct mgp_vertex *v, const char *label_name, int *result);

/// Get a copy of a vertex property mapped to a given name.
/// Returned value must be freed with mgp_value_destroy.
/// NULL is returned if unable to allocate a mgp_value.
enum mgp_error_code mgp_vertex_get_property(const struct mgp_vertex *v, const char *property_name,
                                            struct mgp_memory *memory, struct mgp_value **result);
...
/// NULL is returned if unable to allocate a new iterator.
enum mgp_error_code mgp_vertex_iter_properties(struct mgp_vertex *v, struct mgp_memory *memory,
...
/// NULL is returned if unable to allocate a new iterator.
enum mgp_error_code mgp_vertex_iter_in_edges(struct mgp_vertex *v, struct mgp_memory *memory,
...
/// mgp_edges_iterator_destroy.
/// NULL is returned if unable to allocate a new iterator.
enum mgp_error_code mgp_vertex_iter_out_edges(const struct mgp_vertex *v, struct mgp_memory *memory,
                                              struct mgp_edges_iterator **result);
...
/// NULL is returned if the end of the iteration has been reached.
enum mgp_error_code mgp_edges_iterator_get(struct mgp_edges_iterator *it, struct mgp_edge **result);

/// Advance the iterator to the next edge and return it.
/// The previous mgp_edge obtained through mgp_edges_iterator_get
/// will be invalidated, and you must not use its value.
/// NULL is returned if the end of the iteration has been reached.
enum mgp_error_code mgp_edges_iterator_next(struct mgp_edges_iterator *it, struct mgp_edge **result);
...
/// The ID is only valid for a single query execution, you should never store it
/// globally in a query module.
enum mgp_error_code mgp_edge_get_id(const struct mgp_edge *e, struct mgp_edge_id *result);

/// Copy a mgp_edge.
/// Returned pointer must be freed with mgp_edge_destroy.
/// NULL is returned if unable to allocate a mgp_edge.
enum mgp_error_code mgp_edge_copy(const struct mgp_edge *e, struct mgp_memory *memory, struct mgp_edge **result);
...
enum mgp_error_code mgp_edge_equal(const struct mgp_edge *e1, const struct mgp_edge *e2, int *result);

/// Return the type of the given edge.
enum mgp_error_code mgp_edge_get_type(const struct mgp_edge *e, struct mgp_edge_type *result);

/// Return the source vertex of the given edge.
enum mgp_error_code mgp_edge_get_from(struct mgp_edge *e, struct mgp_vertex **result);

/// Return the destination vertex of the given edge.
enum mgp_error_code mgp_edge_get_to(struct mgp_edge *e, struct mgp_vertex **result);

/// Get a copy of a edge property mapped to a given name.
/// Returned value must be freed with mgp_value_destroy.
/// NULL is returned if unable to allocate a mgp_value.
enum mgp_error_code mgp_edge_get_property(const struct mgp_edge *e, const char *property_name,
                                          struct mgp_memory *memory, struct mgp_value **result);
...
/// mgp_properties_iterator_destroy.
/// NULL is returned if unable to allocate a new iterator.
enum mgp_error_code mgp_edge_iter_properties(const struct mgp_edge *e, struct mgp_memory *memory,
                                             struct mgp_properties_iterator **result);
...
enum mgp_error_code mgp_graph_get_vertex_by_id(struct mgp_graph *g, struct mgp_vertex_id id, struct mgp_memory *memory,
...
/// NULL is returned if unable to allocate a new iterator.
enum mgp_error_code mgp_graph_iter_vertices(const struct mgp_graph *g, struct mgp_memory *memory,
...
/// NULL is returned if the end of the iteration has been reached.
enum mgp_error_code mgp_vertices_iterator_get(struct mgp_vertices_iterator *it, struct mgp_vertex **result);

/// Advance the iterator to the next vertex and return it.
/// The previous mgp_vertex obtained through mgp_vertices_iterator_get
/// will be invalidated, and you must not use its value.
/// NULL is returned if the end of the iteration has been reached.
enum mgp_error_code mgp_vertices_iterator_next(struct mgp_vertices_iterator *it, struct mgp_vertex **result);
///@}
...
enum mgp_error_code mgp_type_any(const struct mgp_type **result);

/// Get the type representing boolean values.
enum mgp_error_code mgp_type_bool(const struct mgp_type **result);

/// Get the type representing character string values.
enum mgp_error_code mgp_type_string(const struct mgp_type **result);

/// Get the type representing integer values.
enum mgp_error_code mgp_type_int(const struct mgp_type **result);

/// Get the type representing floating-point values.
enum mgp_error_code mgp_type_float(const struct mgp_type **result);

/// Get the type representing any number value.
///
/// This is the parent type for numeric types, i.e. INTEGER and FLOAT.
enum mgp_error_code mgp_type_number(const struct mgp_type **result);
...
enum mgp_error_code mgp_type_map(const struct mgp_type **result);

/// Get the type representing graph node values.
///
/// Since a node contains a map of properties, the node itself is also of MAP
/// type.
enum mgp_error_code mgp_type_node(const struct mgp_type **result);
...
/// is also of MAP type.
enum mgp_error_code mgp_type_relationship(const struct mgp_type **result);

/// Get the type representing a graph path (walk) from one node to another.
enum mgp_error_code mgp_type_path(const struct mgp_type **result);

/// Build a type representing a list of values of given `element_type`.
///
/// NULL is returned if unable to allocate the new type.
enum mgp_error_code mgp_type_list(const struct mgp_type *element_type, const struct mgp_type **result);

/// Build a type representing either a `null` value or a value of given `type`.
///
/// NULL is returned if unable to allocate the new type.
enum mgp_error_code mgp_type_nullable(const struct mgp_type *type, const struct mgp_type **result);
///@}
...
enum mgp_error_code mgp_module_add_read_procedure(struct mgp_module *module, const char *name, mgp_proc_cb cb,
...
enum mgp_error_code mgp_proc_add_arg(struct mgp_proc *proc, const char *name, const struct mgp_type *type);
...
/// on success.
enum mgp_error_code mgp_proc_add_opt_arg(struct mgp_proc *proc, const char *name, const struct mgp_type *type,
...
enum mgp_error_code mgp_proc_add_result(struct mgp_proc *proc, const char *name, const struct mgp_type *type);
...
/// as deprecated.
enum mgp_error_code mgp_proc_add_deprecated_result(struct mgp_proc *proc, const char *name,
...
enum mgp_error_code mgp_must_abort(const struct mgp_graph *graph, int *result);
...
/// the payload.
enum mgp_error_code mgp_message_payload(const struct mgp_message *message, const char **result);

/// Return the payload size
enum mgp_error_code mgp_message_payload_size(const struct mgp_message *message, size_t *result);

/// Return the name of topic
enum mgp_error_code mgp_message_topic_name(const struct mgp_message *message, const char **result);

/// Return the key of mgp_message as a byte array
enum mgp_error_code mgp_message_key(const struct mgp_message *message, const char **result);

/// Return the key size of mgp_message
enum mgp_error_code mgp_message_key_size(const struct mgp_message *message, size_t *result);

/// Return the timestamp of mgp_message as a byte array
enum mgp_error_code mgp_message_timestamp(const struct mgp_message *message, int64_t *result);

/// Return the number of messages contained in the mgp_messages list
enum mgp_error_code mgp_messages_size(const struct mgp_messages *message, size_t *result);

/// Return the message from a messages list at given index
enum mgp_error_code mgp_messages_at(const struct mgp_messages *message, size_t index,
                                    const struct mgp_message **result);
...
enum mgp_error_code mgp_module_add_transformation(struct mgp_module *module, const char *name, mgp_trans_cb cb);
/// @}

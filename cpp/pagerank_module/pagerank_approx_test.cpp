...
// TEST_F(PagerankApproxTest, EmptyGraphUpdate) {
...
TEST_F(PagerankApproxTest, DeleteConnectingEdge) {
  pagerank_approx_alg::SetPagerank(*graph);

  graph = mg_generate::BuildGraph({0, 1, 2, 7, 4}, {{0, 2}, {0, 7}, {1, 2}}, mg_graph::GraphType::kDirectedGraph);
  auto results = pagerank_approx_alg::UpdatePagerank(*graph, {}, {}, {}, {{2, 0}});
...
//   auto results = pagerank_approx_alg::UpdatePagerank(*graph, {}, {}, {0, 1, 2, 7, 4}, {{0, 2}, {0, 7}, {1, 2}, {2,
//   0}});

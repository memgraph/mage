...
def test_correct_get_neighbors(
        graph: Graph,
        node: int,
        neighs: List[int]) -> None:
...
@pytest.mark.parametrize("node, weight_nodes", [
    (0, [(1, 2), (2, 1)]),
    (1, [(0, 2), (3, 3), (4, 1)]),
    (2, [(0, 1), (4, 4)]),
    (3, [(1, 3), (4, 1)]),
...
def test_correct_get_weighted_neighbors(
        graph: Graph,
        node: int,
        weight_nodes: List[Tuple[int, float]]) -> None:
...
@pytest.mark.parametrize("node_1, node_2, weight", [
    (0, 1, 2),
    (1, 0, 2),
    (2, 4, 4),
    (3, 1, 3),

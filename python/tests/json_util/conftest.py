...
class MockEdge:
    def __init__(self, id: int, from_vertex: MockVertex, to_vertex: MockVertex, type_name: str, properties: dict):
        self.id = id
...
class MockMgp:
    ...
    class Path:
        def __init__(
            self, vertices: List["MockMgp.Vertex"], edges: List["MockMgp.Edge"]
        ):
            self.vertices = vertices
            self.edges = edges

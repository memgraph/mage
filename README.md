...
| [katz_centrality_online](cpp/katz_centrality_module/katz_centrality_online_module.cpp.py)                                                                   | C++ | Online implementation of the Katz centrality. Outputs the approximate result for Katz centrality while maintaining the order of rankings.

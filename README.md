...
## MAGE Spells
Graph neural network-based node classification module
...
| [kmeans](https://memgraph.com/docs/mage/query-modules/python/kmeans)                                             | Python | Algorithm to cluster given data.                                                                                                                                                                                                  |
| [link_prediction_gnn](https://memgraph.com/docs/mage/query-modules/python/link-prediction-with-gnn)              | Python | Module for predicting links in the graph by using graph neural networks.                                                                                                                                                          |
...
| [node-classification_with_gnn](https://memgraph.com/docs/mage/query-modules/python/node-classification-with-gnn) | Python | Graph neural network-based node classification module.                                                                                                                                                                            |

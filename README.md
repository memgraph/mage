...
| meta                                         | Python | A module that contains procedures describing graphs on a meta-level.                                                                    |
| [node-classification_with_gnn](https://memgraph.com/docs/mage/query-modules/python/node-classification-with-gnn) | Python | A graph neural network-based node classification module.                                                                                                                                                                            |
